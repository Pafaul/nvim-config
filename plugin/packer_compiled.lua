...
_G.packer_plugins = {
  ...
  ["lsp-lens.nvim"] = {
    ...
    url = "https://github.com/Pafaul/lsp-lens.nvim"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
  ...
  ["nvim-ufo"] = {
    loaded = true,
    path = "/Users/pavelmikhailov/.local/share/nvim/site/pack/packer/start/nvim-ufo",
  ...
  ["promise-async"] = {
    loaded = true,
    path = "/Users/pavelmikhailov/.local/share/nvim/site/pack/packer/start/promise-async",
